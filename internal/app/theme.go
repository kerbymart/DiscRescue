...
func newTheme(monochrome bool, dark bool) Theme {
	if monochrome {
		...
		return Theme{Text: plain, Muted: plain.Faint(true), Accent: plain.Bold(true), AccentSoft: plain, Surface: plain, Border: plain, Focus: plain.Bold(true), Success: plain.Bold(true), Warning: plain.Bold(true), Danger: plain.Bold(true), Key: plain.Bold(true), Card: plain, CardFocus: plain.Bold(true), Label: plain.Bold(true), Badge: plain.Bold(true), Divider: plain.Faint(true), RecoveryRecovered: plain.Bold(true), RecoveryDeferred: plain.Bold(true), RecoveryUnreadable: plain.Bold(true), RecoveryPending: plain.Faint(true)}
	}
